          ...
          <div className="contact-card code-card">
            <div className="contact-info-panel">
              <div className="contact-info-content">
                ...
                <div className="social-links">
                  <a className="social-link" href="https://github.com/sovandara-rith" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><i className="fab fa-github" /></a>
            ...
            <div className="contact-form-panel">
              ...
              <form className="contact-form" onSubmit={onSubmit}>
                ...
                <p className="code-label"><span className="kw">let</span> <span className="id">confirmPassword</span> <span className="eq">=</span></p>
                <div className="form-group full-width">
                  <label htmlFor="message" className="sr-only">Message</label>
                  <textarea id="message" name="message" placeholder="Write your message..." required />
                </div>
                <button type="submit" className="submit-btn">
                  {status === "sending" ? "Sending..." : status === "sent" ? "Sent!" : "Next"}
